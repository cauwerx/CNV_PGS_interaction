# Correlation between PGS_GW and CNV carrier status for 119 CNV-trait pairs
...
# PGS data for all individuals (PGS genome-wide; filtered for testing samples IID) 
...
fwrite(df, "CNV_PGS/data/model_PGS/CNV_cor_PGS_GW.txt", col.names = T, row.names = F, quote = F, sep = "\t")
