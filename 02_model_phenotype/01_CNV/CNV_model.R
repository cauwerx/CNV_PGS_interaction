# Model adjusted phenotypes according to CNV status for 119 CNV-trait pairs
...
fwrite(df, "CNV_PGS/data/model_phenotype/CNV_model.txt", col.names = T, row.names = F, quote = F, sep = "\t")